...
function answers_guidance(): array
{
    $lines = [
        ...
        '                     application on its own address or path - an engine at',
        '                     https://retro.example serving its client from /web wants',
        '                     https://retro.example/web here. The same address as',
        '                     instance.url is refused: it would redirect to itself.',
        '                     Without it / answers 503 once the install finishes;',
        '                     the API and the phones work regardless.',
